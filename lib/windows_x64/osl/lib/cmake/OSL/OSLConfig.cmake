...
if (3.2.4 VERSION_GREATER_EQUAL 3.0)
    find_dependency(Imath 3.1.7)
elseif (3.2.4 VERSION_GREATER_EQUAL 2.4 AND 1)
    find_dependency(IlmBase 3.2.4)
    find_dependency(OpenEXR 3.2.4)
    find_dependency(ZLIB 1.2.13)  # Because OpenEXR doesn't do it
    find_dependency(Threads)  # Because OpenEXR doesn't do it
endif ()


find_dependency(OpenImageIO 2.5.11.0 REQUIRED)
